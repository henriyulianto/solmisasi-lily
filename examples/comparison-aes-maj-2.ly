...
bass_notes = \relative c, {
  ...
  \cadenzaOn
  \clef bass
  fes4 f4 ges4 g4 aes4 beses4 bes4 ces4 c4 des4 eeses4 ees4 fes4 f4 ges4 g4 aes4 beses4 bes4 ces4 \clef "treble_8" c4 des4 eeses4 ees4 fes4
}
...
baritone_notes = \relative c, {
  ...
  \cadenzaOn
  \clef bass
  g'4 aes4 beses4 bes4 ces4 c4 des4 eeses4 ees4 fes4 f4 ges4 g4 aes4 beses4 bes4 ces4 \clef "treble_8" c4 des4 eeses4 ees4 fes4 f4 s2
}
...
tenor_notes = \relative c {
  ...
  \cadenzaOn
  \clef bass
  ces4 c4 des4 eeses4 ees4 fes4 f4 ges4 g4 aes4 beses4 bes4 ces4 \clef "treble_8" c4 des4 eeses4 ees4 fes4 f4 ges4 g4 aes4 beses4 s2
}

alto_notes = \relative c {
  \key aes \major
  \cadenzaOn
  \clef treble f4 ges4 g4 aes4 beses4 bes4 ces4 c4 des4 eeses4 ees4 fes4 f4 ges4 g4 aes4 beses4 bes4 ces4 c4 des4 eeses4 ees4 fes4 s4
}

mezzosop_notes = \relative c' {
  \key aes \major
  \cadenzaOn
  \clef treble beses4 bes4 ces4 c4 des4 eeses4 ees4 fes4 f4 ges4 g4 aes4 beses4 bes4 ces4 c4 des4 eeses4 ees4 fes4 f4 ges4 g4 aes4 beses4
}

soprano_notes = \relative c' {
  \key aes \major
  \cadenzaOn
  \clef treble c4 des4 eeses4 ees4 fes4 f4 ges4 g4 aes4 beses4 bes4 ces4 c4 des4 eeses4 ees4 fes4 f4 ges4 g4 aes4 beses4 bes4 ces4 c4 \bar "|."
}
...
score_c_maj = \score {
  <<
    ...
    \new StaffGroup \with {
      ...
      <<
        ...
        \new SolmisasiStaff \with {
          ...
          \new SolmisasiVoice {
            \solmisasiMusic \transposeUpOneOctave \soprano_notes
          }
        }
        \new Staff \with {
          \override VerticalAxisGroup.staff-staff-spacing.padding = #-0.8
        ...
        \new SolmisasiStaff \with {
          ...
          \new SolmisasiVoice {
            \solmisasiMusic \transposeUpOneOctave \mezzosop_notes
          }
        }
        \new Staff \with {
          \override VerticalAxisGroup.staff-staff-spacing.padding = #-0.8
        ...
        \new SolmisasiStaff \with {
          ...
          \new SolmisasiVoice {
            \solmisasiMusic \transposeUpOneOctave \alto_notes
          }
        }
        \new Staff \with {
        ...
        \new SolmisasiStaff \with {
          ...
          \new SolmisasiVoice {
            ...
            \solmisasiMusic \transposeUpOneOctave \tenor_notes
          }
        }
        \new SolmisasiStaff \with {
          \override BarLine.allow-span-bar = ##f
        ...
        \new SolmisasiStaff \with {
          ...
          \new SolmisasiVoice {
            \override NoteHead.color = #grey
            \solmisasiMusic \transposeUpOneOctave \baritone_notes
          }
        }
        \new SolmisasiStaff \with {
          \override BarLine.allow-span-bar = ##f
        ...
        \new SolmisasiStaff \with {
          ...
          \new SolmisasiVoice {
            \override NoteHead.color = #grey
            \solmisasiMusic \transposeUpOneOctave \bass_notes
          }
        }
        \new SolmisasiStaff \with {
          \override BarLine.allow-span-bar = ##f
    ...
    % \new SolmisasiStaff {
    %       \new Voice {
    %         \solmisasiMusic \transposeUpOneOctave \music_solmisasi
    %       }
    %     }
  >>
  \layout {
