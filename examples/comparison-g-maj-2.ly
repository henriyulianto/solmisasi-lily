...
bass_notes = \relative c, {
  ...
  \cadenzaOn
  \clef bass
  e4 f fis g gis a ais b c cis d dis e f fis g gis a ais b \clef "treble_8" c cis d dis e
}
...
baritone_notes = \relative c, {
  ...
  \cadenzaOn
  \clef bass
  g'4 gis a ais b c cis d dis e f fis g gis a ais b \clef "treble_8" c cis d dis e f s2
}
...
tenor_notes = \relative c {
  ...
  \cadenzaOn
  \clef bass
  b4 c cis d dis e f fis g gis a ais b \clef "treble_8" c cis d dis e f fis g gis a s2
}

alto_notes = \relative c {
  \key g \major
  \cadenzaOn
  \clef treble f4 fis g gis a ais b c cis d dis e f fis g gis a ais b c cis d dis e s4
}

mezzosop_notes = \relative c' {
  \key g \major
  \cadenzaOn
  \clef treble a4 ais b c cis d dis e f fis g gis a ais b c cis d dis e f fis g gis a
}

soprano_notes = \relative c' {
  \key g \major
  \cadenzaOn
  \clef treble c4 cis d dis e f fis g gis a ais b c cis d dis e f fis g gis a ais b c \bar "|."
}
