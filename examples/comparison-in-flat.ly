...
bass_notes = \relative c, {
  \clef bass
  e4 f ges g aes a bes b c des d ees e f ges g aes a bes b \clef "treble_8" c des d ees e
}

baritone_notes = \relative c, {
  \cadenzaOn
  \clef bass
  g'4 aes a bes b c des d ees e f ges g aes a bes b \clef "treble_8" c des d ees e f s2
}

tenor_notes = \relative c {
  \cadenzaOn
  \clef bass
  b4 c des d ees e f ges g aes a bes b \clef "treble_8" c des d ees e f ges g aes a s2
}

alto_notes = \relative c {
  \cadenzaOn
  \clef treble f4 ges g aes a bes b c des d ees e f ges g aes a bes b c des d ees e s4
}

mezzosop_notes = \relative c' {
  \cadenzaOn
  \clef treble a4 bes b c des d ees e f ges g aes a bes b c des d ees e f ges g aes a
}

soprano_notes = \relative c' {
  \cadenzaOn
  \clef treble c4 des d ees e f ges g aes a bes b c des d ees e f ges g aes a bes b c \bar "|."
}
